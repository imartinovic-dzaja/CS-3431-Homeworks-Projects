...
/* ++++++++++++++++++++++++++++++++++++++++++++++
  Make sure you did the following before execution
     ...
     2) Set environment variables using the .bash_profile file you wrote:
       > source .bash_profile

     3) Write your java code (say file name is OracleTest.java) and then compile it using the  following command
	...
	System.out.println("-------- Step 2: Building a Connection ------");
        ...
        try {
            connection = DriverManager.getConnection(
                                                     "jdbc:oracle:thin:@oracle.wpi.edu:1521:orcl", "your oracle username",
